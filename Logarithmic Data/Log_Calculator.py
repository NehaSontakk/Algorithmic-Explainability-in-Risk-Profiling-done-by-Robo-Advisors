							...
							for p in range(len(x_52)):
								for q in range(len(x_61)):
									for r in range(len(x_62)):
										list_of_values.append([w_11,x_11[i],w_21,x_21[j],w_22,x_22[k],w_31,x_31[l],w_32,x_32[m],w_41,x_41[n],w_51,x_51[o],w_52,x_52[p],w_61,x_61[q],w_62,x_62[r],w_11*3*math.log(x_11[i],3)+w_21*2*math.log(x_11[i]*x_21[j],2)+w_22*3*math.log(x_11[i]*x_22[k],2)+w_31*3*math.log(x_11[i]*x_31[l],2)+w_32*3*math.log(x_11[i]*x_32[m],2)+w_41*x_41[n]+w_51*3*math.log(x_11[i]*x_32[m]*x_51[o],2)+w_52*x_52[p]*x_62[r]+w_61*2*math.log(x_61[q]*x_11[i],2)+w_62*x_62[r]*x_11[i]])
...
df.to_csv('x_11_1_log.csv', index=False)
